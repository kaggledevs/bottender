...
So, to make a WhatsApp Bot works, you have to fill in the below environment variables in your `.env` file:
...
Then, you could copy the ngork URL and paste it to the Twilio:

![](https://user-images.githubusercontent.com/3382565/75419069-f8490b80-596f-11ea-99d2-2b2bec96ff7a.png)

Once is ready for production, deploy and URL instead
